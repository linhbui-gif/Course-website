   ...
   <div class="NewsPage">
      <section class="Banner">
        <div class="Banner-wrapper"> 
          <div class="Banner-image" style="height: 26.4rem;"><img src="./assets/images/image-banner-new.png" alt=""></div>
                      ...
                      <div class="NewsPage-list-item">
                        <div class="NewBlock vertical">
                            <a class="NewBlock-image" href="{{route('details_news',['slug'=> $news['alias'] ])}}">
                              <img src="{{$news['image_location']}}" alt="">
                            </a>
                    ...
                    @foreach($list_news['data'] as $news)   
                      <div class="NewsPage-list-hightlight-item">
                        <div class="NewBlock horizontal">
                            <a class="NewBlock-image" href="chi-tiet-tin-tuc-su-kien.html"><img src="{{$news['image_location']}}" alt=""></a>
                          <div class="NewBlock-info">
                            <a class="NewBlock-info-title" href="chi-tiet-tin-tuc-su-kien.html">{{ $news['title'] }}</a>
                          </div>
