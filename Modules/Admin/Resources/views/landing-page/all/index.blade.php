<form id="frm_update_all" action="<?=route('admin::landingPagePosition.store-all')?>">
        ...
        <div class="modal-content">
            <form id="frm_add_item">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><span class="label-action">Thêm mới</span></h4>
                </div>
                <div class="modal-body">
                    <div id="frm_update_position_image" class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <h4 class="title-block">Tiêu đề</h4>
                                <input type="text" id="images_title" name="images_title" class="form-control"
                                       placeholder="" value="">
                            </div>
                            @if($position_type['item_subtitle'])
                                <div class="form-group">
                                    <h4 class="title-block">Tiêu đề phụ</h4>
                                    <input type="text" class="form-control" id="images_subtitle" name="images_subtitle" value="">
                                </div>
                            @endif
                            <div class="form-group">
                            ...
                            @if($position_type['item_title_link'])
                                <div class="form-group">
                                    <h4 class="title-block">Tên liên kết</h4>
                        ...
                        @if($position_type['item_description'])
                            <div class="col-md-12">
                                <h4 class="title-block">Mô tả</h4>
                                <div class="form-group">
                                <textarea id="images_description_adminnifty" rows="10" cols="5"
                                          class="images_description_adminnifty form-control "></textarea>
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="modal-footer text-center">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa fa-floppy-o" aria-hidden="true"></i> Lưu thông tin Item</button>
                </div>
            </form>
        </div>
    </div>
