<section data-bg="https://gse.edu.vn/wp-content/themes/gnws/assets/images/bg-form.png" class="form__contact section__pd bg-cover rocket-lazyload entered lazyloaded" id="tuvan" style="background-image: url(&quot;https://gse.edu.vn/wp-content/themes/gnws/assets/images/bg-form.png&quot;);" data-ll-status="loaded">
    <div class="container">
        <div class="main-form ">
            <p>
                    ...
                    <div class="col-md-6">
                        <div class="Select small">
                            <select class="Select-control" name="level_course">
                                ...
                                <option value="2">Bậc học 1</option>
                                <option value="3">Bậc học 2</option>
                                <option value="4">Bậc học 3</option>
