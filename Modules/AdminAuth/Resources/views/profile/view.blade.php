                    ...
                    <div class="col-md-4">
                        <div class="Card ProfilePage-table-content">
                            ...
                            <div class="Card-body" style="padding: 2rem;">
                                ...
                                <div class="TrackProfile-text">Khóa học: <strong>@if($course) {{ $course->name }} @endif</strong></div><br>
                                ...
                                @if($profile->status == "inactive")
                                    <div class="TrackProfile-text">Trạng thái: <strong class="pending">Đang chờ xét duyệt</strong></div>
                                @else
                                    <div class="TrackProfile-text">Trạng thái: <strong class="success">Đã duyệt</strong></div>
                                @endif
                                <br>
                                <form id="frmUpdate" action="{{ route('adminauth::profile.postView',['id' => $id]) }}" method="POST">
                                    <div class="form-group">
                                        <label for="">Cập nhật trạng thái</label>
                                        {!! Form::select("status", [ 'active' => 'Duyệt', 'inactive' => 'Chờ duyệt' ], $profile->status, [ 'id' => 'status', 'class' => 'form-control']) !!}
                                    </div>
