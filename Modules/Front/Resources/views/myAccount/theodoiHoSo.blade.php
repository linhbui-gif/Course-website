                            ...
                            <div class="Card-body">
                                ...
                                <div class="TrackProfile-item-wrapper Collapse">
                                    <div class="Collapse-header">
                                        <div class="TrackProfile-header flex items-center justify-between @if($school->type_school == 3) {{'odd'}} @elseif($school->type_school == 2) {{'even'}} @else {{'custom_red'}} @endif">
                                                    ...
                                                    <div class="TrackProfile-item-col">
                                                        <div class="TrackProfile-text">Trạng thái:
                                                            @if($i->status == "inactive")
                                                                <strong class="pending">Đang chờ xét duyệt</strong>
                                                            @else
                                                                <strong class="success">Đã duyệt</strong>
                                                            @endif
