      ...
      <div class="list-link">
          <div class="container">
              <ul class="nav">
                  ...
                  <li class="menu-item menu-item-type-taxonomy menu-item-object-university_category"><a class="active" href="javascript:void(0)" data-electronic="nganhhoc" target="_self" rel="follow noopener noreferrer">Các ngành học</a></li>
