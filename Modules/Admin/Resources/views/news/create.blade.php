                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input readonly type="text" name="alias" id="alias" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="form-field-1"> <strong>
                                                        Hình ảnh <span class="required"></span></strong>
                                                </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="10" cols="5" class="form-control" name="description" id="description"
