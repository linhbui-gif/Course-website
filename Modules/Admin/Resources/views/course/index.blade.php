    ...
    <div id="page-content">
        ...
        <div class="panel panel-bordered-primary">
            ...
            @include("admin::includes.data-table",[
                ...
                'change_status'     => true,
                'fields' => [
                    ['field' => 'name','title' => 'Tên khóa học'],
                    ['field' => 'image_url','title' => 'Hình','formatter' => 'formatImage'],
                    ['field' => 'created_at','title' => 'Ngày tạo','formatter' => 'formatDate'],
                    ['field' => 'show_home','title' => 'Hiển thị Home','formatter' => 'formatStatusCourseHome','sortable' => 'true'],
...
@section('after_scripts')
    ...
    <script>
        function formatStatusCourseHome(value, row, index) {
            if(value)
            {
                return '<span class="label label-sm label-success">Hiển thị</span>'
            }
            else
            {
    ...
    <script type="text/javascript">
        ...
        function queryParams(params) {
            ...
            params.position_id = $('#position_id').val();
