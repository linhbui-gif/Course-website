...
use Modules\Admin\Repositories\Majors\MajorsRepositoryInterface;
...
class MajorsController extends Controller
{
    ...
    public function __construct(
        MajorsRepositoryInterface $repository

    )
    {
        $this->repo = $repository;
        $this->data['controllerName'] = 'admin::majors';
    } 
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $this->validate($request,['status' => 'nullable','name' => ['required',Rule::unique('majors')->ignore($id, 'id')],], $messages);
        $object = Majors::find($id);
        if (!$object)
        {
