    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btn_add_item_required').click(function(e) {
                ...
                $("#container_input_requierd").append('<div class="input_required_item"><div class="form-group"><label class="col-sm-3 control-label" for="form-field-1">Title<span class="required"></span></label><div class="col-sm-9"><input name="required[yeucau_'+items+'][title]" id="" class="form-control"><label id="required_title-error" class="error" for="required">{!! $errors->first("required") !!}</label></div></div><div class="form-group"><label class="col-sm-3 control-label" for="form-field-1">Content<span class="required"></span></label><div class="col-sm-9"><textarea class="form-control add_summer_required" name="required[yeucau_'+items+'][content]" id="" cols="50" rows="10"></textarea><label id="required_content-error" class="error" for="required_content">{!! $errors->first("required") !!}</label></div></div></div>')
            ...
            let html = `<div class="col-md-3 gallery_item" style="margin-top:30px;">
                            ...
                            <span class="btn btn-sm btn-success btn-rounded fileinput-button">
                              ...
                              <input id="fileupload_`+index_gallery+`" type="file" name="files[]"
                                ...
                                <input id="image_location_gallery_`+index_gallery+`" type="hidden" name="gallery[image_location_gallery_`+index_gallery+`] "value="">
                            </div>
