         ...
         <form id="frm-add" method="POST" action="<?=$link?>" class="form-horizontal" enctype='multipart/form-data'>
            <div class="panel-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 20px;">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="education_program-tab" data-toggle="tab" href="#education_program" role="tab" aria-controls="education_program" aria-selected="false">Chưởng trình giảng dạy</a>
                      </li>
                      <li class="nav-item">
