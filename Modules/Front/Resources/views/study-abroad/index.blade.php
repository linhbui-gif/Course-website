...
@section('content')
  ...
  <section class="header__link">
      <div class="list-link">
          <div class="container">
              <ul class="nav">
                  <li class="menu-item menu-item-type-post_type menu-item-object-du_hoc current-menu-item menu-item-27583"><a class="menu-item-link active" href="#" data-electronic="school" target="_self" rel="follow noopener noreferrer">Tổng quan</a></li>
  ...
  <section class="country-content">
      <div class="container">
          <div class="tab-contents active" id="school">
              <div class="row">
                  <div class="col-lg-12">
